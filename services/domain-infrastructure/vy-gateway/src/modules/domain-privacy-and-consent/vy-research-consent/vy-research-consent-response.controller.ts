...
@Controller()
export class ResearchConsentResponseController {
  private logger = getLoggerConfig(ResearchConsentResponseController.name);

  constructor(private readonly kafkaResponder: KafkaResponderService) {
    this.logger.debug(
      `${ResearchConsentResponseController.name} initialized`,
      '',
      'constructor',
