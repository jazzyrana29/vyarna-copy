...
@Controller()
export class SalesReferralsResponseController {
  private logger = getLoggerConfig(SalesReferralsResponseController.name);

  constructor(private readonly kafkaResponder: KafkaResponderService) {
    this.logger.debug(
      `${SalesReferralsResponseController.name} initialized`,
      '',
      'constructor',
