...
@Controller()
export class SalesStoreResponseController {
  private logger = getLoggerConfig(SalesStoreResponseController.name);

  constructor(private readonly kafkaResponder: KafkaResponderService) {
    this.logger.debug(
      `${SalesStoreResponseController.name} initialized`,
      '',
      'constructor',
