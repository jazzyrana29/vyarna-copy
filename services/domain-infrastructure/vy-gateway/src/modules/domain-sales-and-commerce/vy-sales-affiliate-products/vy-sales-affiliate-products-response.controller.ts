...
@Controller()
export class SalesAffiliateProductsResponseController {
  private logger = getLoggerConfig(SalesAffiliateProductsResponseController.name);

  constructor(private readonly kafkaResponder: KafkaResponderService) {
    this.logger.debug(
      `${SalesAffiliateProductsResponseController.name} initialized`,
      '',
      'constructor',
