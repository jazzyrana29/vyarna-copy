...
@Controller()
export class SalesSubscriptionsResponseController {
  private logger = getLoggerConfig(SalesSubscriptionsResponseController.name);

  constructor(private readonly kafkaResponder: KafkaResponderService) {
    this.logger.debug(
      `${SalesSubscriptionsResponseController.name} initialized`,
      '',
      'constructor',
