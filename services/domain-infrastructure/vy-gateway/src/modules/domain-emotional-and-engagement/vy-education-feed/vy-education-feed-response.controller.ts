...
@Controller()
export class EducationFeedResponseController {
  private logger = getLoggerConfig(EducationFeedResponseController.name);

  constructor(private readonly kafkaResponder: KafkaResponderService) {
    this.logger.debug(
      `${EducationFeedResponseController.name} initialized`,
      '',
      'constructor',
