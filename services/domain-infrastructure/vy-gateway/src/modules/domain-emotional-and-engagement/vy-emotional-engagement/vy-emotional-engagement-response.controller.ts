...
@Controller()
export class EmotionalEngagementResponseController {
  private logger = getLoggerConfig(EmotionalEngagementResponseController.name);

  constructor(private readonly kafkaResponder: KafkaResponderService) {
    this.logger.debug(
      `${EmotionalEngagementResponseController.name} initialized`,
      '',
      'constructor',
