...
@Controller()
export class PersonProviderResponseController {
  private logger = getLoggerConfig(PersonProviderResponseController.name);

  constructor(private readonly kafkaResponder: KafkaResponderService) {
    this.logger.debug(
      `${PersonProviderResponseController.name} initialized`,
      '',
      'constructor',
