...
@Controller()
export class PersonParentResponseController {
  private logger = getLoggerConfig(PersonParentResponseController.name);

  constructor(private readonly kafkaResponder: KafkaResponderService) {
    this.logger.debug(
      `${PersonParentResponseController.name} initialized`,
      '',
      'constructor',
