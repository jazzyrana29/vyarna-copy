...
@Controller()
export class PersonEmployeeResponseController {
  private logger = getLoggerConfig(PersonEmployeeResponseController.name);

  constructor(private readonly kafkaResponder: KafkaResponderService) {
    this.logger.debug(
      `${PersonEmployeeResponseController.name} initialized`,
      '',
      'constructor',
