...
@Controller()
export class PersonMilkGiverResponseController {
  private logger = getLoggerConfig(PersonMilkGiverResponseController.name);

  constructor(private readonly kafkaResponder: KafkaResponderService) {
    this.logger.debug(
      `${PersonMilkGiverResponseController.name} initialized`,
      '',
      'constructor',
