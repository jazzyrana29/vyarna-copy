...
@Controller()
export class PersonFamilyGraphResponseController {
  private logger = getLoggerConfig(PersonFamilyGraphResponseController.name);

  constructor(private readonly kafkaResponder: KafkaResponderService) {
    this.logger.debug(
      `${PersonFamilyGraphResponseController.name} initialized`,
      '',
      'constructor',
