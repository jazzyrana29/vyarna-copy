...
@Controller()
export class PersonBabyResponseController {
  private logger = getLoggerConfig(PersonBabyResponseController.name);

  constructor(private readonly kafkaResponder: KafkaResponderService) {
    this.logger.debug(
      `${PersonBabyResponseController.name} initialized`,
      '',
      'constructor',
