...
@Controller()
export class PersonRolesResponseController {
  private logger = getLoggerConfig(PersonRolesResponseController.name);

  constructor(private readonly kafkaResponder: KafkaResponderService) {
    this.logger.debug(
      `${PersonRolesResponseController.name} initialized`,
      '',
      'constructor',
