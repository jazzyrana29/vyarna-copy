...
@Controller()
export class PersonConsumerResponseController {
  private logger = getLoggerConfig(PersonConsumerResponseController.name);

  constructor(private readonly kafkaResponder: KafkaResponderService) {
    this.logger.debug(
      `${PersonConsumerResponseController.name} initialized`,
      '',
      'constructor',
