...
@Controller()
export class PersonCosharerResponseController {
  private logger = getLoggerConfig(PersonCosharerResponseController.name);

  constructor(private readonly kafkaResponder: KafkaResponderService) {
    this.logger.debug(
      `${PersonCosharerResponseController.name} initialized`,
      '',
      'constructor',
