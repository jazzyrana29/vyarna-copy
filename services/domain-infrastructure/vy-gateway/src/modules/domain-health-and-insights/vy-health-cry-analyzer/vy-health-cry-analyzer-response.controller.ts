...
@Controller()
export class HealthCryAnalyzerResponseController {
  private logger = getLoggerConfig(HealthCryAnalyzerResponseController.name);

  constructor(private readonly kafkaResponder: KafkaResponderService) {
    this.logger.debug(
      `${HealthCryAnalyzerResponseController.name} initialized`,
      '',
      'constructor',
