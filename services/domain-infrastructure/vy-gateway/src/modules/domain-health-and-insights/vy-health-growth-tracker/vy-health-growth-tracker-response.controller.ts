...
@Controller()
export class HealthGrowthTrackerResponseController {
  private logger = getLoggerConfig(HealthGrowthTrackerResponseController.name);

  constructor(private readonly kafkaResponder: KafkaResponderService) {
    this.logger.debug(
      `${HealthGrowthTrackerResponseController.name} initialized`,
      '',
      'constructor',
