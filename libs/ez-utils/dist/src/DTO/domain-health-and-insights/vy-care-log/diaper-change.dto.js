...
exports.DiaperChangeDto = void 0;
const swagger_1 = require("@nestjs/swagger");
const class_validator_1 = require("class-validator");
class DiaperChangeDto {
}
exports.DiaperChangeDto = DiaperChangeDto;
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Unique identifier', required: true }),
    (0, class_validator_1.IsUUID)(),
    __metadata("design:type", String)
], DiaperChangeDto.prototype, "diaperChangeId", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Baby identifier', required: true }),
    (0, class_validator_1.IsUUID)(),
    __metadata("design:type", String)
], DiaperChangeDto.prototype, "babyId", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Person logging the change', required: true }),
    (0, class_validator_1.IsUUID)(),
    __metadata("design:type", String)
], DiaperChangeDto.prototype, "personId", void 0);
__decorate([
...
__decorate([
    ...
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], DiaperChangeDto.prototype, "notes", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Soft delete flag', required: false }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsBoolean)(),
    __metadata("design:type", Boolean)
], DiaperChangeDto.prototype, "isDeleted", void 0);
__decorate([
