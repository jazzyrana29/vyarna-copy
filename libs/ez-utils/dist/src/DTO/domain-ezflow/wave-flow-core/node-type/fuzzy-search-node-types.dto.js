...
exports.FuzzySearchNodeTypesDto = void 0;
...
class FuzzySearchNodeTypesDto extends (0, swagger_1.PartialType)((0, swagger_1.PickType)(node_type_dto_1.NodeTypeDto, [
    "name",
    "description",
    "updatedBy",
    "isDeleted",
...
exports.FuzzySearchNodeTypesDto = FuzzySearchNodeTypesDto;
__decorate([
...
], FuzzySearchNodeTypesDto.prototype, "fuzzyName", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({
    ...
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], FuzzySearchNodeTypesDto.prototype, "fuzzyDescription", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({
        description: "Fuzzy match for the user who updated the Node Type (optional)",
    }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], FuzzySearchNodeTypesDto.prototype, "fuzzyUpdatedBy", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({
...
], FuzzySearchNodeTypesDto.prototype, "pagination", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({
...
], FuzzySearchNodeTypesDto.prototype, "sort", void 0);
//# sourceMappingURL=fuzzy-search-node-types.dto.js.map