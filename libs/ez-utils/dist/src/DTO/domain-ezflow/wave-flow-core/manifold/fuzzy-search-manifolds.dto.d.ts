...
declare const FuzzySearchManifoldsDto_base: import("@nestjs/common").Type<Partial<Pick<ManifoldDto, "name" | "description" | "isDeleted" | "updatedBy" | "nodeId" | "executionStyle">>>;
