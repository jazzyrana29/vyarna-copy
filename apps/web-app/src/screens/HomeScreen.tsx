...
const HomeScreen: FC = (): JSX.Element => {
  ...
  return (
    <>
      <Helmet>
        <title>Vyarna – Real Breast Milk. Reinvented.</title>
        <meta
          name="description"
          content="Vyarna is freeze-dried brilliance — simple, safe, and ready when you are. Made from real, screened breast milk for modern families."
        />
        <meta
          property="og:title"
          content="Vyarna – Real Breast Milk. Reinvented."
        />
        <meta
          property="og:description"
          content="Vyarna is freeze-dried breast milk—lab-tested, shelf-stable, and ready to add to formula, food, or nursing. Now accepting waitlist preorders."
        />
        <meta
          property="og:image"
        ...
        <meta
          ...
          content="Vyarna is freeze-dried brilliance — simple, safe, and ready when you are."
        />
        <meta
          name="twitter:image"
          content={`${baseUrl}/assets/images/home/boosterBox.jpg`}
        ...
        <View className="max-w-screen-xl mx-auto px-4 py-8 font-raleway">
          ...
          >
            ...
            <Text className="text-base text-center text-black mb-10">
              Vyarna fits into your feeding routine—no matter how you feed your
              baby.
            </Text>
...
One pacekt. Real breast milk. Ready when you are.`}
          ...
          <View className="py-16 px-4 max-w-screen-xl mx-auto">
            <Email
              ...
              description="Sign up to reserve your Booster pack, share with friends, and help launch Vyarna into the world."
...
Single-gram Booster sachets are sealed, QR-coded, and shelf-stable for 24 months. Every batch is tested, tracked, and traceable. No formulas. No synthetics. Just the good stuff, preserved.`}
              linkText="Find out more about how Vyarna is made."
...
Vyarna fits your routine.`}
              linkText="Vyarna For Parents."
