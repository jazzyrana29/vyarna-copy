...
export const SOCKET_NAMESPACE_FINANCE_WALLET = 'finance-wallet';
export const KT_RECORD_TRANSACTION = 'record-transaction';
export const KT_RECORD_TRANSACTION_RESULT = `${KT_RECORD_TRANSACTION}-${RESULT}`;
export const KT_RECORD_TRANSACTION_ERROR = `${KT_RECORD_TRANSACTION}-${ERROR}`;
